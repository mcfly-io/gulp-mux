...
var runTasksSequential = exports.runTasksSequential = function(gulp, tasks, cb) {
    var runSeq = runSequence.use(gulp);
    if(cb) {
        tasks.push(cb);
    }
...
var createAndRunTasksSequential = exports.createAndRunTasksSequential = function(gulp, fn, taskname, targets, mode, constants, cb) {
    var tasks = createTasks(gulp, fn, taskname, targets, mode, constants);
 ...
 */
var sanitizeWatchFolders = exports.sanitizeWatchFolders = function(folders) {
