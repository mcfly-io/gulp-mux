...
var createTasks = exports.createTasks = function(gulp, fn, taskname, targets, constants) {
    ...
    var tasks = [];
    targets.templates.forEach(function(templateObj, index) {
        var targetConstants = resolveConstants(constants, templateObj);
